...
Cluster 1 is composed of Brazil, China, France, Germany, Libya, Portugal, South Korea, Sweden, the United Kingdom and the United States. 
```{r,echo=FALSE, error=FALSE, warning=FALSE, message=FALSE, fig.align='center'}
...
#ggplot(dataset_covid_10_countries, x = Death.Ratio.Population, y = Population, color = Country)
#ggplot(dataset_covid_10_countries) + aes(x = Country) + geom_bar()
...
ggplot(dataset_covid_10_countries) +
 ...
 geom_col() + scale_y_continuous("Deaths per millions inhabitants", limits = c(0,600)) + scale_x_discrete(labels=c( "Republic of Korea" = "South Korea", "United States of America" = "United States"), limits=c("Brazil", "China", "Germany", "Libya", "Portugal", "South Korea", "France", "Sweden", "United Kingdom", "United States of America")) + scale_fill_discrete(name = "Country", labels = c("Brazil", "China", "France", "Germany", "Libya", "Portugal", "South Korea", "Sweden", "United Kingdom", "United States of America")) +
