...
distance <- get_dist(correlation_matrix)
fviz_dist(distance, gradient = list(low = "#00AFBB", mid = "white", high = "#FC4E07"))


set.seed(20)
clusters <- kmeans(dataset_final_correl2, 2, nstart = 25)
clusters


§§§§§§§§§§§§ PROBLEME ICI $$$$$$$$$$$$$
dataset_final2$Cluster <- as.factor(clusters$cluster)

fviz_cluster(clusters$cluster, data = correlation_matrix)
