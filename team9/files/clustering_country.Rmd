...
dataset_WGI1 <- read_excel("dataset_WGI_2018_Voice_Accountability.xlsx")
...
dataset_WGI2 <- read_excel("dataset_WGI_2018_Corruption.xlsx")
...
dataset_WGI3 <- read_excel("dataset_WGI_2018_Rule_of_Law.xlsx")
...
dataset_WGI4 <- read_excel("dataset_WGI_2018_Government_Effectiveness.xlsx")
...
#SAVING DATASET FINAL in a EXCEL FILE
write_xlsx(x = dataset_final2, path = "dataset_final_WGI_capacity_access.xlsx", col_names = TRUE)
